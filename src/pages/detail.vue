<template>
  <div>
      <detail-header :item="goodsList"></detail-header>
      <detail-jian :item="goodsList"></detail-jian>
      <detail-section :item="goodsList"></detail-section>
      <detail-footer :item="goodsList"></detail-footer>
  </div>
</template>
<script type="text/ecmascript-6">
  import detailHeader from '../components/detail/detailHeader.vue'
  import detailFooter from '../components/detail/detailFooter.vue'
  import detailJian from '../components/detail/detailJian.vue'
  import detailSection from '../components/detail/detailSction.vue'
  ...
  export default {
    ...
    mounted(){
      console.log('goodsList: ' + this.$route.params.goodsList);
...
<style scoped>
  @import "../assets/css/ordershow.css";
</style>
