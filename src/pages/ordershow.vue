<template>
  <div>
    <ordershow-header></ordershow-header>
    <ordershow-section></ordershow-section>
    <orders-footer></orders-footer>
  </div>

</template>
<script type="text/ecmascript-6">
  import ordershowHeader from '../components/ordershow/ordershowHeader.vue'
  import ordershowSection from '../components/ordershow/ordershowSection.vue'
  import ordersFooter from '../components/index/footer.vue'
